 ...
 */
@Data
@Schema(description = "用户数阶梯创建DTO")
public class UserCountLadderCreateDTO implements Serializable {
     ...
     * 用户数下限
     */
    @NotNull(message = "用户数下限不能为空")
    @Min(value = 0, message = "用户数下限不能为负数")
     ...
     * 用户数上限，NULL表示无上限
     */
    @Min(value = 0, message = "用户数上限不能为负数")
    @Schema(description = "用户数上限，NULL表示无上限")
